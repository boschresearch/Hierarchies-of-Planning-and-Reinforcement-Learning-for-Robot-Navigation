...
from lib.trpo.trpo_parking_vi_rl import TRPOTrainer
...
def run_fun(seed_list,
    ...
    config_dict = {
        ...
        'optimistic_model': optimistic_model
    }
    save_path = ""
    ...
    for seed_val in seed_list:
        ...
        # INITIALIZATION #
        myTRPO = TRPOTrainer(state_dim=6,
                             action_dim=2,
