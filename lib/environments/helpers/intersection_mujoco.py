...
def calc_line_object_border_intersection_point(p1, p2, obj_def, seg_num):
    if seg_num == 0:
        coll_point = calc_line_intersection_point(p1_l1=p1,
                                                  p2_l1=p2,
                                                  p1_l2=(obj_def[0], obj_def[1]),
                                                  p2_l2=(obj_def[0] + obj_def[2], obj_def[1]))
        normal_vec = (0, 1)
    elif seg_num == 1:
        coll_point = calc_line_intersection_point(p1_l1=p1,
                                                  p2_l1=p2,
                                                  p1_l2=(obj_def[0] + obj_def[2], obj_def[1]),
                                                  p2_l2=(obj_def[0] + obj_def[2], obj_def[1] + obj_def[3]))
        normal_vec = (1, 0)
    elif seg_num == 2:
        coll_point = calc_line_intersection_point(p1_l1=p1,
                                                  p2_l1=p2,
                                                  p1_l2=(obj_def[0], obj_def[1]),
                                                  p2_l2=(obj_def[0], obj_def[1] + obj_def[3]))
        normal_vec = (1, 0)
    elif seg_num == 3:
        coll_point = calc_line_intersection_point(p1_l1=p1,
                                                  p2_l1=p2,
                                                  p1_l2=(obj_def[0], obj_def[1] + obj_def[3]),
                                                  p2_l2=(obj_def[0] + obj_def[2], obj_def[1] + obj_def[3]))
        normal_vec = (0, 1)
